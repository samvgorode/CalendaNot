...
public class Attendee {
    ...
    public int addToEvent(final ContentResolver contentResolver, final Event event) throws SecurityException {
        eventID = event.id;
    ...
    public static List<Attendee> getAttendeesForQuery(final String query, final String[] queryArgs, final String sortOrder, final ContentResolver contentResolver) throws SecurityException {
